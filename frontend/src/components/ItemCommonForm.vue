...
export default {
    ...
    computed: {
        ...
        year_releaseErrors: function() {
            ...
            !this.$v.form.year_release.required && errors.push('Year is required');
            !this.$v.form.year_release.numeric && errors.push('Year should be a number');
            return errors;
        }
    },
    methods: {
        submit: function() {
            ...
            this.$emit('next', !this.$v.form.$invalid);
        },
        reset: function() {
